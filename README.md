...
A project that captures live audio on the UNIHIKER K10, classifies customer feedback categories from speech with a quantized CNN generated by Edge Impulse, and visualizes results on both the device TFT and a live web dashboard served directly from the board.
